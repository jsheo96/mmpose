...
data = dict(
    ...
    train=dict(
        ...
        ann_file=(f'{data_root}/train/'
                  f'deepfashion2_short_sleeved_outwear_train.json'),
    ...
    val=dict(
        type='DeepFashionDataset',
        ann_file=(f'{data_root}/validation/'
                  f'deepfashion2_short_sleeved_outwear_validation.json'),
